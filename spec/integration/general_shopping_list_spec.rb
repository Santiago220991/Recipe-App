...
recipe=Recipe.create(name:"bulgogi", preparation_time:2, cooking_time:1, description:"good", public:true, user:user)
food_recipe=RecipeFood.create(quantity:5, recipe:recipe, food:food)
visit root_url
